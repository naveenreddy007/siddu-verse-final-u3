...
interface PersonalInfoStepEnhancedProps {
  data: ProfileFormData
  updateData: (updates: Partial<ProfileFormData>) => void
}

export function PersonalInfoStepEnhanced({ data, updateData }: PersonalInfoStepEnhancedProps) {
      ...
      <Card className="bg-[#282828] border-[#3A3A3A]">
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <LocationPicker
              value={data.location || { city: "", state: "", country: "" }}
