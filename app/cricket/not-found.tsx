...
export default function CricketNotFound() {
  return (
    <div className="container mx-auto px-4 py-16 text-center">
      <h1 className="text-4xl font-bold text-[#E0E0E0] mb-4">404</h1>
      <h2 className="text-2xl font-bold text-[#E0E0E0] mb-6">Cricket Content Not Found</h2>
      <p className="text-[#A0A0A0] mb-8">The cricket content you're looking for doesn't exist or has been moved.</p>
